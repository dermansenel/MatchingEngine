...
import com.staj.MatchingEngine.fix.FixServer;
...
public class MatchingEngineApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            fixServer.start();
            System.out.println("Fix baslatildi. Emirler bekleniyor...\n---------------------------------------------");
            
        } catch (Exception e) {
            System.out.println("❌ FIX Server başlatılamadı: " + e.getMessage());
            e.printStackTrace();
        }
