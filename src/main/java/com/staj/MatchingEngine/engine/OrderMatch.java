...
public class OrderMatch {
    ...
    public synchronized boolean cancelOrder(String orderId) {
        // Buy orders listesinde ara
        for (int i = 0; i < buyOrders.size(); i++) {
            if (buyOrders.get(i).getId().equals(orderId)) {
                buyOrders.remove(i);
                return true;
            }
        }
    ...
    private List<Trade> processSideBuy(Order order) {
        ...
        // En yüksek fiyat önce girer...
        Collections.sort(this.buyOrders, (o1, o2) -> Integer.compare(o2.getPrice(), o1.getPrice()));
        return trades;
    }
